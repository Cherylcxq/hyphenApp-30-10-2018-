...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("hyphenApp.Droid.Services.LocationServiceConnection, hyphenApp.Android", LocationServiceConnection.class, __md_methods);
	}
	...
	public LocationServiceConnection ()
	{
		...
		if (getClass () == LocationServiceConnection.class)
			mono.android.TypeManager.Activate ("hyphenApp.Droid.Services.LocationServiceConnection, hyphenApp.Android", "", this, new java.lang.Object[] {  });
	}

	public LocationServiceConnection (md58cff868cd811b0aa5723b6ef0b24f392.LocationServiceBinder p0)
	{
		super ();
		if (getClass () == LocationServiceConnection.class)
			mono.android.TypeManager.Activate ("hyphenApp.Droid.Services.LocationServiceConnection, hyphenApp.Android", "hyphenApp.Droid.Services.LocationServiceBinder, hyphenApp.Android", this, new java.lang.Object[] { p0 });
	}
